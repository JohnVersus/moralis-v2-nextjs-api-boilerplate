...
export type getBlockResult = Pick<Exclude<Awaited<ReturnType< typeof Moralis.EvmApi.block.getBlock >>, null>, "result">['result'];
export type getDateToBlockResult = Pick<Awaited<ReturnType< typeof Moralis.EvmApi.block.getDateToBlock >>, 'result'>['result'];
