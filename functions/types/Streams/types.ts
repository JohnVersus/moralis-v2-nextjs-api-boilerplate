...
export type addAddressResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.addAddress >>, 'result'>['result'];
export type deleteResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.delete >>, 'result'>['result'];
export type deleteAddressResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.deleteAddress >>, 'result'>['result'];
export type getAddressesResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.getAddresses >>, 'result'>['result'];
export type getAllResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.getAll >>, 'result'>['result'];
export type getByIdResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.getById >>, 'result'>['result'];
export type getHistoryResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.getHistory >>, 'result'>['result'];
export type parsedLogsResult = Awaited<ReturnType< typeof Moralis.Streams.parsedLogs >>;
export type readSettingsResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.readSettings >>, 'result'>['result'];
export type retryResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.retry >>, 'result'>['result'];
export type setSettingsResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.setSettings >>, 'result'>['result'];
export type updateResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.update >>, 'result'>['result'];
export type updateStatusResult = Pick<Awaited<ReturnType< typeof Moralis.Streams.updateStatus >>, 'result'>['result'];
